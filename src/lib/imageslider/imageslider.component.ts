...
export class ImagesliderComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    console.log("huyyyyyyyyyyy");

    console.log(this.slideImages);

    this.loading = false;
    // this.slideImages.push(this.certificate[this.lastIndex]);
    // this.loading = false;
  }
  ...
  next() {
    ...
    // this.loading = true;
    // if (this.lastIndex + 1 < this.certificate.length) {
    //   this.lastIndex = this.lastIndex + 1;
    //   this.slideImages = [];
    //   this.slideImages.splice(0, 0, this.certificate[this.lastIndex]);
    // } else {
    //   this.nextImageNotAvailable();
    // }
  }
